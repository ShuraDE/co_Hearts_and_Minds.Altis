...
*/
 ...
 //[(this select 0), 0, ["ACE_MainActions"],_actionIntelSearch] call ace_interact_menu_fnc_addActionToObject;
 ...
 //["Civilian_F", 0, ["ACE_MainActions"],_actionIntelSearch] call ace_interact_menu_fnc_addActionToObject;
