...
//Disarm Explosives
 _actionDisarmIED = ["DisarmIED", "Disarm IED", "", {btc_int_target = cursorTarget; btc_int_target spawn btc_fnc_ied_check_for;}, {true;}] call ace_interact_menu_fnc_createAction;
...
{
	[_x, 1, ["ACE_MainActions"], _actionCheckIED] call ace_interact_menu_fnc_addActionToClass;
} forEach btc_type_ieds;

{
	[_x, 1, ["ACE_MainActions"], _actionDisarmIED] call ace_interact_menu_fnc_addActionToClass;
} forEach btc_type_ieds;
